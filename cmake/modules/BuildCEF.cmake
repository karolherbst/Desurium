...
if(BUILD_CEF OR BUILD_ONLY_CEF)
  ...
  if(WIN32 AND NOT MINGW)
    ...
    if(DEBUG_CEF)
      set(CEF_BUILD_CMD msbuild ${WORKING_DIR}/cef/cef.sln /target:libcef /consoleloggerparameters:verbosity=minimal /m /p:Platform=Win32 /p:Configuration=Debug)
      set(CEF_LIB_DIR ${WORKING_DIR}/cef/Debug/)
    else()
      set(CEF_BUILD_CMD msbuild ${WORKING_DIR}/cef/cef.sln /target:libcef /consoleloggerparameters:verbosity=minimal /m /p:Platform=Win32 /p:Configuration=Release)
      set(CEF_LIB_DIR ${WORKING_DIR}/cef/Release/)
    endif()
    set(CEF_LIBRARIES "${CEF_LIB_DIR}/cef.dll" "${CEF_LIB_DIR}/icudt.dll")
    ...
    set(CEF_BUILD_CMD ${CMAKE_SCRIPT_PATH}/depot_tools_wrapper.sh ${DEPOT_TOOLS_BIN_DIR} ${MY_BUILD_TOOL} libcef V=1 $ENV{MAKEOPTS} CC.host=${CMAKE_C_COMPILER} CXX.host=${CMAKE_CXX_COMPILER} LINK.host=${CMAKE_CXX_COMPILER} AR.host=${CMAKE_AR} BUILDTYPE=Release)

    set(CEF_LIB_DIR ${CHROMIUM_SOURCE_DIR}/src/out/Release/lib.target)
    set(CEF_FFMPEG_LIB_DIR ${CHROMIUM_SOURCE_DIR}/src/out/Release)
    set(CEF_LIBRARIES "${CEF_LIB_DIR}/libcef.so")
